...
"vs_2_0
					...
					//
					    ...
					    mul r1.xy, r0, c5
					    mov r1.zw, -r1.xyxy
					    mad r0.zw, r0.xyxy, -c5.xyxy, v0.xyxy
...
"vs_4_0
					...
					void main()
					{
					    ...
					    u_xlat0.xy = _MainTex_TexelSize.xy * _BlurOffsets.xy;
					    u_xlat0.zw = (-u_xlat0.xy);
					    u_xlat1.xy = (-_MainTex_TexelSize.xy) * _BlurOffsets.xy + in_TEXCOORD0.xy;
					    vs_TEXCOORD0.zw = u_xlat0.zy + u_xlat1.xy;
					    vs_TEXCOORD1.xy = u_xlat0.xw + u_xlat1.xy;
					    vs_TEXCOORD1.zw = (-_MainTex_TexelSize.xy) * _BlurOffsets.xy + u_xlat1.xy;
					    return;
					}"
}
SubProgram "d3d11_9x " {
